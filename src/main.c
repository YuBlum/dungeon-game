...
move_system(void) {
  ...
  for (Entity e = 0; e < ecs_entities_amount(); e++) {
    position[e] = v2_add(position[e], v2_muls(velocity[e], global.dt));
...
main(void) {
  ...
  movable_colored_rect_create(V2F(-3.0f, -1.0f), V2S(0.3f), V2F(1, 0), C_GREEN);
  movable_colored_rect_create(V2F(-5.5f, -2.0f), V2S(1.2f), V2F(1, 0), C_BLACK);
  movable_colored_rect_create(V2F(-4.5f, -3.0f), V2S(0.4f), V2F(1, 0), C_MAGENTA);
  movable_colored_rect_create(V2F(-6.0f, -4.0f), V2S(1.0f), V2F(1, 0), C_YELLOW);
  ...
  movable_colored_rect_create(V2F(+5.0f, +0.0f), V2F(0.25f, 0.25f), V2F(+5, +0), C_YELLOW);
  movable_colored_rect_create(V2F(+5.0f, -4.0f), V2F(2.0f, 1.5f),   V2F(+5, +5), C_WHITE);
  movable_colored_rect_create(V2F(-6.0f, +4.0f), V2F(1.0f, 1.0f),   V2F(+0, -5), C_BLUE);
  movable_colored_rect_create(V2F(-2.0f, -2.0f), V2F(5.0f, 1.0f),   V2F(-5, +0), C_GREEN);
