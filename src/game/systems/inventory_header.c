...
system_inventory_header(usize entities_amount) {
  for (Entity e = 0; e < entities_amount; e++) {
    ...
    renderer_text(V2F(UI_RIGHT - 1.625f, global.game.inventory_y - PX_TO_UNIT), 1, false, false, 0xff5500ff, 1, "@");
    renderer_text(V2F(UI_LEFT + (UI_W - 2.0f) * 0.5f - 1.5f, global.game.inventory_y - PX_TO_UNIT), 1, false, false, 0xff5500ff, 1, "Name");
    renderer_text(V2F(UI_RIGHT - 1.625f, global.game.inventory_y), 1, false, false, 0xffffaaff, 1, "@");
    renderer_text(V2F(UI_LEFT + (UI_W - 2.0f) * 0.5f - 1.5f, global.game.inventory_y), 1, false, false, 0xffffaaff, 1, "Name");
  }
}
