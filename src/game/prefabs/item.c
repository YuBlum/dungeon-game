...
void
prefab_item_melee(const char *name, u32 weight, u32 id, bool equiped, u32 dice_amount, u32 dice_faces, u32 test_modifier, u32 critical_hit, u32 attribute_threshold) {
  DiceTest dice_test = {
    dice_amount,
    dice_faces,
    test_modifier
  ...
  ecs_entity_creation_begin("item", "active", "dice-test", "critical-hit", "attribute-threshold", "item-equiped");
...
void
prefab_item_ranged(const char *name, u32 weight, u32 id, bool equiped, u32 dice_amount, u32 dice_faces, u32 test_modifier, u32 critical_hit, u32 attribute_threshold, AmmoType ammo_type) {
  DiceTest dice_test = {
    dice_amount,
    dice_faces,
    test_modifier
  ...
  ecs_entity_creation_begin("item", "active", "dice-test", "critical-hit", "ammo-type", "attribute-threshold", "item-equiped");
    ecs_entity_creation_setup_component(Item, "item", item);
    ecs_entity_creation_setup_component(DiceTest, "dice-test", dice_test);
    ecs_entity_creation_setup_component(u32, "critical-hit", critical_hit);
...
void
prefab_item_staff(const char *name, u32 weight, u32 id, bool equiped, SpellType spell_type, u32 reduce_spell_dt, u32 attribute_threshold) {
  Staff staff = {
    spell_type,
    reduce_spell_dt
  };
  Item item;
  setup_item(&item, name, ITEM_MELEE, weight, id);
  ecs_entity_creation_begin("item", "active", "staff", "attribute-threshold", "item-equiped");
    ecs_entity_creation_setup_component(Item, "item", item);
...
void
prefab_item_ammo(const char *name, u32 weight, u32 id, AmmoType ammo_type, u32 amount) {
  Item item;
  setup_item(&item, name, ITEM_RANGED, weight, id);
  ecs_entity_creation_begin("item", "active", "ammo-type", "item-amount");
    ecs_entity_creation_setup_component(Item, "item", item);
    ecs_entity_creation_setup_component(AmmoType, "ammo-type", ammo_type);
...
void
prefab_item_defensive(const char *name, u32 weight, u32 id, bool equiped, u32 attribute_threshold, DefensiveType defensive_type, u32 extra_armour_points) {
  ...
  Item item;
  setup_item(&item, name, ITEM_MELEE, weight, id);
  ecs_entity_creation_begin("item", "active", "attribute-threshold", "item-equiped", "defensive-item");
    ecs_entity_creation_setup_component(Item, "item", item);
    ecs_entity_creation_setup_component(u32, "attribute-threshold", attribute_threshold);
    ecs_entity_creation_setup_component(bool, "item-equiped", equiped);
...
void
prefab_item_lockpick(const char *name, u32 weight, u32 id, LockpickType lockpick_type, u32 amount) {
  Item item;
  setup_item(&item, name, ITEM_RANGED, weight, id);
  ecs_entity_creation_begin("item", "active", "lockpick-type", "item-amount");
    ecs_entity_creation_setup_component(Item, "item", item);
...
void
prefab_item_potion(const char *name, u32 weight, u32 id, u32 dice_amount, u32 dice_faces, u32 test_modifier, PotionType potion_type, u32 amount) {
  DiceTest dice_test = {
    dice_amount,
    dice_faces,
    test_modifier
  ...
  Item item;
  setup_item(&item, name, ITEM_RANGED, weight, id);
  ecs_entity_creation_begin("item", "active", "potion-type", "dice-test", "item-amount");
    ecs_entity_creation_setup_component(Item, "item", item);
...
void
prefab_item_magic_component(const char *name, u32 weight, u32 id, MagicComponentType magic_component_type, u32 amount) {
  Item item;
  setup_item(&item, name, ITEM_RANGED, weight, id);
  ecs_entity_creation_begin("item", "active", "magic-component-type", "item-amount");
    ecs_entity_creation_setup_component(Item, "item", item);
