...
static const DataID data_ids[] = {
  ...
  [CHARACTER_SHEET_NAME_BUFF]           = { 0x004, 0x008 },
  [CHARACTER_SHEET_CLASS]               = { 0x00c, 0x004 },
  [CHARACTER_SHEET_ATTRIBUTE_AGI]       = { 0x010, 0x004 },
  [CHARACTER_SHEET_ATTRIBUTE_INT]       = { 0x014, 0x004 },
  [CHARACTER_SHEET_ATTRIBUTE_PRE]       = { 0x018, 0x004 },
  [CHARACTER_SHEET_ATTRIBUTE_STR]       = { 0x01c, 0x004 },
  [CHARACTER_SHEET_ATTRIBUTE_VIG]       = { 0x020, 0x004 },
  [CHARACTER_SHEET_GOLD]                = { 0x024, 0x004 },
  [CHARACTER_SHEET_LEVEL]               = { 0x028, 0x004 },
  [CHARACTER_SHEET_EXPERIENCE]          = { 0x02c, 0x004 },
  [CHARACTER_SHEET_ARMOUR_POINTS]       = { 0x030, 0x004 },
  [CHARACTER_SHEET_HIT_POINTS_MAX]      = { 0x034, 0x004 },
  [CHARACTER_SHEET_HIT_POINTS_CUR]      = { 0x038, 0x004 },
  [CHARACTER_SHEET_FOOD_POINTS_MAX]     = { 0x03c, 0x004 },
  [CHARACTER_SHEET_FOOD_POINTS_CUR]     = { 0x040, 0x004 },
  [CHARACTER_SHEET_ESSENCE_POINTS_MAX]  = { 0x044, 0x004 },
  [CHARACTER_SHEET_ESSENCE_POINTS_CUR]  = { 0x048, 0x004 },
  [CHARACTER_SHEET_CARRYING_WEIGHT_CUR] = { 0x04c, 0x004 },
  [CHARACTER_SHEET_CARRYING_WEIGHT_MAX] = { 0x050, 0x004 },
};
#if DEVMODE
_Static_assert(sizeof (data_ids) / sizeof (DataID) == SERIALIZATION_TYPE_LAST, "Not all serialization types handled");
#endif

#define SERIALIZATION_BUFFER_SIZE 0x054
