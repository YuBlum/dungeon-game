...
void __scene_manager_create_scene(Scene scene, const char *name, const char *file, u32 line);
...
#define scene_manager_create_scene(SCENE) __scene_manager_create_scene(SCENE, #SCENE, __FILE__, __LINE__)
#define scene_manager_is_current_scene(SCENE) __scene_manager_is_current_scene(#SCENE, __FILE__, __LINE__)
#define scene_manager_goto_scene(SCENE) __scene_manager_goto_scene(#SCENE, __FILE__, __LINE__)
