...
void __scene_manager_create_scene(const char *name, SceneFn on_start_fn, SceneFn on_update_fn, const char *file, u32 line);
...
#define scene_manager_create_scene(SCENE, ON_START_FN, ON_UPDATE_FN) __scene_manager_create_scene(SCENE, ON_START_FN, ON_UPDATE_FN, __FILE__, __LINE__)
