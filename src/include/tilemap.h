...
bool __tilemap_is_in_bounds(V2f position, const char *file, u32 line);
...
#define tilemap_is_in_bounds(POSITION) __tilemap_is_in_bounds(POSITION, __FILE__, __LINE__)
